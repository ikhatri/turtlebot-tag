...
"""autogenerated by genpy from turtlebot_tag/GetFreePathSrvRequest.msg. Do not edit."""
import sys
...
class GetFreePathSrvRequest(genpy.Message):
  _md5sum = "9990b3cde2866f776c81e00c9e086a37"
  _type = "turtlebot_tag/GetFreePathSrvRequest"
...
string frame_id
"""
  __slots__ = ['laser_scan','v','w']
  _slot_types = ['sensor_msgs/LaserScan','float32','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetFreePathSrvRequest, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2f().pack(_x.v, _x.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.v, _x.w,) = _get_struct_2f().unpack(str[start:end])
      return self
...
def _get_struct_2f():
    ...
    return _struct_2f
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from turtlebot_tag/GetFreePathSrvResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetFreePathSrvResponse(genpy.Message):
  _md5sum = "79c5379529f76e6a7f5e100191a058dd"
  _type = "turtlebot_tag/GetFreePathSrvResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetFreePathSrvResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
def _get_struct_Bf():
    ...
    return _struct_Bf
class GetFreePathSrv(object):
  _type          = 'turtlebot_tag/GetFreePathSrv'
  _md5sum = '4dbf2c0b49713b0f6d232f2c3eb14392'
  _request_class  = GetFreePathSrvRequest
  _response_class = GetFreePathSrvResponse
